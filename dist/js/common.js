$(function() {
  ...
  // $('.add--commtent__modal .rating svg').each(function(index, item) {
  ...
  $('.catalog--product .add-toCart--js').on('click', function() {
    $('.header__management .header--cart_counter').toggleClass('active');
    $('.header__management .header--cart_counter').text('1');
  });
